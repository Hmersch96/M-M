...
def main():
    """Evolve a genome."""
    population = 20 # Number of networks/genomes in each generation. Se recomienda usar 50/30
    ...
    generations = 30 # Number of times to evolve the population. #Se recomienda 100/50
    all_possible_genes = {
